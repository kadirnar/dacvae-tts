...
# Label -> (repo id, file, repo type). All public: downloads never use a token. WER: Freya-TR-Eval x 48 leak-free
# Common Voice voices, one sample per sentence, refit duration predictor, sampling seeds 42 + 1000.
EXPERIMENTS = "VoiceHub/dacvae-tts-tr-combined"
CHECKPOINTS = OrderedDict(
    [
        ("full-v2 60k · tr-combined (WER 0.93 %)", (EXPERIMENTS, "full-v2/checkpoints/step-0060000.pt", "model")),
        ("full-cross 60k · tr-combined (WER 2.94 %)", (EXPERIMENTS, "full-cross/checkpoints/step-0060000.pt", "model")),
        ("run C · w512-clean 60k · previous model (WER 5.10 %)", ("VoiceHub/dacvae-tts-tr-w512", "model.pt", "model")),
    ]
)
...
DURATION = _download(EXPERIMENTS, "duration/duration_trc.json", "model")  # predictor refit on tr-combined
