#!/usr/bin/env bash
# full-v2 60k with the duration predictor refit on tr-combined (single sample, seeds 42 and 1000).
cd /workspace/dacvae-tts
set -a; . /workspace/.env; set +a
CK=/workspace/runs/trc-full-v2/step-0060000.pt; DM=/workspace/outputs/trc/duration_trc.json
for spec in "predictor-trc predictor 42" "predictor-trc-s1000 predictor 1000"; do
  set -- $spec
  out=/workspace/outputs/trc/systems/v2-$1
